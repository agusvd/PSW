        ...
        <motion.section id="contact" className="shadow-md relative overflow-hidden pt-10 pb-10" ref={ref}>
            <div className="relative z-10 flex flex-col md:flex-row justify-center items-center md:justify-normal md:items-center gap-8">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full">
                            ...
                            <motion.textarea 
                                ...
                                transition={{ duration: 0.3 }}
                                placeholder="Mensaje..." 
                                className="border-b-2 py-3 px-4 col-span-2 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-lg"
                            />
                        </div>

                        <motion.button
                            whileHover={{ scale: 1.1, backgroundColor: "#508C9B" }}
                            transition={{ duration: 0.3 }}
                            className="w-full py-3 rounded-lg text-white bg-[#134B70] hover:bg-[#508C9B] active:bg-[#0A3A4E] duration-500 ease-in-out"
                        >
                            Enviar
                        </motion.button>
                    </form>
                ...
                <motion.div 
                    ...
                    className="relative w-full md:w-1/2 h-[400px] rounded-2xl shadow-md overflow-hidden"
                >
                    <img
