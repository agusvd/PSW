...
const PageMerluzaA = () => {
    ...
    const exportMarkets = "Cumpliendo con las regulaciones sanitarias chilenas y garantizando la trazabilidad, la Merluza Austral se exporta a diversos mercados internacionales.";
    const benefits = [
